package com.project.jasonshop.components.aspects;
...
public class PerformanceAspect {
    ...
    //@Pointcut("within(com.project.jasonshop.controllers.*)")
    //@Pointcut("within(com.project.jasonshop.controllers.CategoryController)")
