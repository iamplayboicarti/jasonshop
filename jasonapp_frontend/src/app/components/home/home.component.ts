...
export class HomeComponent extends BaseComponent implements OnInit {
  ...
  addProductToCart(event: Event, productId: number): void {
    event.stopPropagation(); // Không navigate vào trang product detail
    this.cartService.addToCart(productId, 1);
    this.toastService.showToast({
      error: null,
      defaultMsg: 'Sản phẩm đã được thêm vào giỏ hàng',
